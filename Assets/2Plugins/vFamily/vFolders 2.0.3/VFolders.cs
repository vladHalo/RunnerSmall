...
namespace VFolders
{
    public static class VFolders
    {
        ...
        public static Texture2D GetSmallFolderIcon(FolderInfo folderInfo) // used by vTabs 
        {
            var key = folderInfo.iconNameOrPath + folderInfo.color + folderInfo.isEmpty + isDarkTheme;
            ...
            void generateAndCache()
            {
                ...
                void insertAssetIcon()
                {
                    ...
                    var assetIconOriginal = EditorGUIUtility.IconContent(folderInfo.iconNameOrPath).image as Texture2D;
        ...
        public static void DrawBigFolderIcon(Rect rect, FolderInfo folderInfo) // used by vFavorites 
        {
            Rect folderIconRect;
            Rect assetIconRect;
            ...
            void assetIcon()
            {
                ...
                var texture = EditorGUIUtility.IconContent(folderInfo.iconNameOrPath).image;
