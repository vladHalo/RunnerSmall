...
namespace VFolders
{
    ...
    public class VFoldersCache : ScriptableSingleton<VFoldersCache>
    {
        ...
        public void AddIcon(string key, Texture2D icon)
        {
        ...
        public bool HasIcon(string key) => instance.iconTextureDatas_byKey.ContainsKey(key);

        public Dictionary<string, Texture2D> iconTextures_byKey = new Dictionary<string, Texture2D>();
        public SerializableDictionary<string, TextureData> iconTextureDatas_byKey = new SerializableDictionary<string, TextureData>();
